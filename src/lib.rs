...
//! let tuple_list = tuple.to_tuple_list();      // but can be converted to tuple_list, which does
//! assert_eq!(
//!   tuple_list.foo(),
...
pub trait TupleRef<'a> {
    ...
    /// Convertes reference to tuple into tuple of mutable references
